...
//        dd(User::latest()->where('role_id',2)->get());
        if (request()->ajax()) {
            return datatables()->of(User::latest()->where([['role_id',"=",2],['acc_type',"=","company"]])->get())
