                ...
                <div class="row login-box-12">
                    <div class="col-lg-4 col-md-12 col-sm-12 px-0">
                        <div class="login_right">
                            ...
                            <p>{{ $setting->internet_entrepreneurs_text ?? '' }}</p>
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="login-inner-form">
                            <div class="details">
                                <h3>
                                    <span>Internet Entrepreneurs </span>Application
                                </h3>
                                <form action="{{ route('entrepreneurs.submit') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-lr">
                                            <div class="form-group">
                                                <input value="{{ old('num_of_websites') }}" autocomplete="num_of_websites" data-validation="required" class="input-text" id="num_of_websites" name="num_of_websites" placeholder="Number Of Websites" type="number">
                                                @error('num_of_websites')
                                                <p style="color: red; text-align: left">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-lr">
                                            <div class="form-group">
                                                <input value="{{ old('current_primary_web_url') }}" data-validation="required" autocomplete="current_primary_web_url" class="input-text" id="current_primary_web_url" name="current_primary_web_url" placeholder="Current Primary Website URL*" required type="text">
                                                @error('current_primary_web_url')
                                                <p style="color: red; text-align: left">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        </div>
